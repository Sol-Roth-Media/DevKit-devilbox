#!/bin/bash
# author Solomon Rothman - Originated from Devilbox-cli https://github.com/louisgab/devilbox-cli
export DEVILBOX_PATH="./servers/DevKit-devilbox"
